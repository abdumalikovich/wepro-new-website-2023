    ...
    <client-only>
      ...
      >
        <div
          class="_width"
          v-if="
            allData.groups.body.filter(
              (item) => item.courseId._id == allData.course.body._id
            ).length
          "
        >
          <div class="_heading">
          ...
          <client-only>
            <groups-list
              v-if="allData.groups.body.length"
              :list="
                allData.groups.body.filter(
                  (item) => item.courseId._id == allData.course.body._id
                )
      ...
      <div class="_width">
        ...
        <div class="wrapper">
          ...
          <div class="item">
            ...
            <span
              >12-месячный доступ ко всем материалам и сертификат курса</span
            >
          </div>
          <div class="item">
            <img src="~/static/img/course/4.svg" />
            <span
              >Смотрите онлайн лекции в любое время на компьютере или
              смартфоне</span
            >
          </div>
        </div>
      ...
      <div class="_width">
        ...
        <div class="wrapper">
          <div class="item">
            ...
            <p>
              Тем, кто никогда не сталкивался с профессией, но хочет с нуля
              приобрести новые востребованные навыки и сменить сферу
              деятельности.
            </p>
          </div>
          <div class="item">
            ...
            <p>
              Качайте свои профессиональные навыки. Совершенствуйтесь в этой
              области вместе с нашим курсом.
            </p>
          </div>
          <div class="item">
            ...
            <p>
              Дизайнеры, разработчики, маркетологи и все, кто интересуется
              программированием
            </p>
          </div>
        </div>
    ...
    <div class="after-course _width">
      ...
      <div class="wrapper">
        <div class="item">
          ...
          <p>
            Можно выполнять проекты различной сложности. Понимать потребности
        ...
        <div class="item">
          ...
          <p>
            Вы изучаете каждую программу с основ и выполняете учебные проекты,
            которыми вы можете дополнить портфолио.
          </p>
        </div>
        <div class="item">
          ...
          <p>
            Рекламные агентства, веб-студии и крупные компании, где вы можете
            найти работу в отделах маркетинга и развития.
          </p>
        </div>
        <div class="item">
          ...
          <p>
            Вы поймете, как правильно структурировать и представлять проекты
            клиентам.
          </p>
        </div>
      </div>
  ...
  .ready-to-start-block {
    .wrapper {
      ...
      .item {
        ...
        transition: 0.45s;
        cursor: pointer;
        background: linear-gradient(135deg, var(--corp) 0, #8d12fa 100%);
        ...
        &:nth-child(2) {
          background: linear-gradient(135deg, #d7b899 0, #a87446 100%);
        }

        &:nth-child(3) {
          background: linear-gradient(135deg, var(--black) 0, #10162f 100%);
        }
      }
    }
  }
